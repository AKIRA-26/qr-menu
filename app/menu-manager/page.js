    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-orange-500 text-white p-4 flex justify-between items-center">
        <div>
          ...
          <p className="text-orange-100 text-sm">Add, edit or remove dishes</p>
        </div>
        <button
          onClick={openAddForm}
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-2 mt-1 focus:outline-none focus:border-orange-400"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Aromatic basmati rice with tender chicken"
                ...
                <div key={item.id}
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-xl font-semibold ${item.is_available
                    ...
                    <button
                      ...
                      className="text-xs bg-blue-100 text-blue-600 px-3 py-1.5 rounded-xl font-semibold hover:bg-blue-200"
                    >
                      Edit
                    </button>
                    ...
                    <button
                      ...
                      className="text-xs bg-red-100 text-red-500 px-3 py-1.5 rounded-xl font-semibold hover:bg-red-200"
                    >
                      Delete
                    </button>
                  </div>
